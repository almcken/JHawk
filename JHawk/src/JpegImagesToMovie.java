...
public class JpegImagesToMovie implements ControllerListener, DataSinkListener {
	...
	public JpegImagesToMovie(String tempdir){
		m_tempDir = tempdir;
	}
	...
	System.out.println("here " +v.size());
	imageToMovie.doIt(176, 144, 10f, v, oml);
	 ...
	 */
 	public void read(Buffer buf) throws IOException {
		...
		return;
	        ...
	        BufferedImage image = (BufferedImage)images.elementAt(nextImage);
            //image.saveImage
	        //TODO
	        String imageFile = m_tempDir + "\\" + "movtemp.jpg";
	    ...
	    raFile = new RandomAccessFile(imgFile, "r");
